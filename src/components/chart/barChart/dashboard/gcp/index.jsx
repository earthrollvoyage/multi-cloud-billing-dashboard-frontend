...
import GCPFilterComponent from '../../../../filter/dashboard/gcp';
...
const DashboardBarChartAnalytics = ({
  ...
  const { gcpFilterDataSet } = useContext(GCPFilterDataContext);

  useEffect(() => {
    const {dateRange, granularity, groupBy, listSelectBy} = filterDataSet;
    filterGCPCostByPeriod(dateRange.startDate, dateRange.endDate, granularity, groupBy, listSelectBy).then((res) => {
