...
export default function RadioButtonsGranularity({ granularity, handleOnChange }) {
  const [value, setValue] = React.useState(granularity);
  ...
  return (
      ...
      {/* <Typography style={{ 
          ...
          fontWeight: "bold"  }}>Granularity</Typography> */}
      ...
      <RadioGroup 
          ...
          <FormControlLabel classes={{label: classes.label}} control={customFirstRadio} value="monthly" label="MONTHLY" />
          <FormControlLabel classes={{label: classes.label}} control={customSecRadio} value="daily" label="DAILY" />
      </RadioGroup>
      </FormControl>
  );
}
