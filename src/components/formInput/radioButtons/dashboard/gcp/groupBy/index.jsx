...
export default function RadioButtonsGroupBy({ groupBy, handleOnChange}) {
  ...
  return (
      ...
      <RadioGroup 
          ...
          <FormControlLabel classes={{label: classes.label}} control={customFirstRadio} value="project_cost" label="Project" />
          <FormControlLabel classes={{label: classes.label}} control={customSecRadio} value="service_cost" label="Service" />
      </RadioGroup>
      </FormControl>
  );
}
