...
export async function listMonthlyAWSCost(periodStart, periodEnd, group_by) {

    const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/aws/billing/dashboard/cost/group/find_by_monthly";
    try {
