...
async function listDailyAWSCost(periodStart, periodEnd, group_by) {

  const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/aws/billing/dashboard/cost/group/find_by_daily";
  try {
...
listDailyAWSCost('2021-12-01', '2021-12-31', 'linked_account')