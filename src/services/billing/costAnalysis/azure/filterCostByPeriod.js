...
export async function filterAzureCostByPeriod(periodStart, periodEnd, granularity, group_by, listSelectBy) {

  const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/azure/billing/dashboard/cost/group/find_by_period";
  try {
...
// filterAzureCostByPeriod('2021-01-01', '2021-12-31', 'MONTHLY', 'service_family', [])