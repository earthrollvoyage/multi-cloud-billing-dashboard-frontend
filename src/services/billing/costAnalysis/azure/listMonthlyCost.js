...
export async function listMonthlyAzureCost(periodStart, periodEnd, group_by) {

    const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/azure/billing/dashboard/cost/group/find_by_monthly";
    try {
...
// listMonthlyCost('2021-10-01', '2021-11-30', 'service')