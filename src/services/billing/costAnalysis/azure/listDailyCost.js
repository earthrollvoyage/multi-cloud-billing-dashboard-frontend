...
export async function listDailyAzureCost(periodStart, periodEnd, group_by) {

  const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/azure/billing/dashboard/cost/group/find_by_daily";
  try {
