...
export async function listMonthlyGCPCost(periodStart, periodEnd, group_by) {

    const url = "https://ybk48wv4yc.execute-api.ap-southeast-1.amazonaws.com/v1/centralized_data/gcp/billing/dashboard/cost/group/find_by_monthly";
    try {
